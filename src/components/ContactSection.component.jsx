    ...
    <section className="h-auto w-full flex justify-center px-4 xl:px-0">
      <div className="max-w-con w-full flex justify-start flex-col md:flex-row items-center z-10 py-20 xl:py-32">
        <div className=" w-full">
          ...
          <div className="w-full xl:w-72 flex flex-row xl:flex-row justify-start items-center py-8">
            <div className="pr-4">
          ...
          <div className="w-full xl:w-72 flex flex-row justify-start items-center py-8">
            <div className="pr-4">
