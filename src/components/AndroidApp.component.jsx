...
const AndroidApp = () => {
    return (
        <section className="h-auto w-full flex justify-center bg-smartphoneBg bg-fixed bg-center bg-cover">
            <div className="max-w-con w-full flex justify-start items-center z-10">
                <div className="py-20 w-5/12">
                    ...
                    <p className="text-white">Molim vrijednu pcelicu da osmisli nesto genijalno i ovde. Lorem ipsum
                    ...
                    <button
                        className="bg-blue-400 p-4 mt-32 text-white rounded-md cursor-pointer hover:bg-blue-800 transition-all"> Preuzmite
                        s Google play
                    </button>
                </div>
            </div>
