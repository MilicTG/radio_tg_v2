    ...
    >
      <div className="max-w-con w-full flex justify-start items-center z-10">
        <div className="py-20 w-full lg:w-5/6 xl:w-5/12">
          ...
          >
            Bez emisija, bez reklama i bez vijesti!!! Glazba od 0 do 24 sata.
            Sviramo samo hitove. Molio bih kolumnistu da mi pomogne. Lorem ipsum
            dolor sit amet, consectetur adipiscing elit. Maecenas et metus
